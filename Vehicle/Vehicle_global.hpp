...
// ----------------------------------------------------------------------------------------
static std::string NAME_VEHICLEDATACREATE         = ("VehicleDataCreate");
static std::string NAME_VEHICLEDATACREATEARGV     = ("VehicleDataCreateArgv");
static std::string NAME_VEHICLEDATASEND           = ("VehicleDataSend");
static std::string NAME_VEHICLEDATAREADERLISTENER = ("VehicleDataReaderListener");
static std::string NAME_VEHICLEDATAWRITERLISTENER = ("VehicleDataWriterListener");
static std::string NAME_VEHICLEDATADESTROY        = ("VehicleDataDestroy");
