...
The examples are tested in Ubuntu 24.04.
...
5. `VehicleMonitor.py`  : a simple python (v3.12) demo application showing 3 vehicles and using OpenDDS
6. There are two test scripts:
   1. `start_all.bash` to start 3 vehicles and a python application.
   2. `stop_all.bash` to stop them all.
