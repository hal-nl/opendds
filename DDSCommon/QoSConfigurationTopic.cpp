/*
 * File:   QoSConfigurationTopic.cpp
 *
 ...
 * @return
 */
int DDSConfiguration::SetTopicQosFromXML(DDS::TopicQos& topic_qos)
{
  if (_valid) {
    string element("");
 ...
 * @return
 */
std::string DDSConfiguration::ShowValuesTopicQos(const DDS::TopicQos& topic_qos)
{
   if (_valid)
   {
      string ss;
      ...
      // Policy kinds:
      ss.append("\tdurability kind: ").append(to_string(topic_qos.durability.kind)).append("\n");
      ss.append("\tliveliness kind: ").append(to_string(topic_qos.liveliness.kind)).append("\n");
      ss.append("\treliability kind: ").append(to_string(topic_qos.reliability.kind)).append("\n");
      ss.append("\tdestination_order kind: ").append(to_string(topic_qos.destination_order.kind)).append("\n");
      ss.append("\thistory kind: ").append(to_string(topic_qos.history.kind)).append("\n");
      ss.append("\townership kind: ").append(to_string(topic_qos.ownership.kind)).append("\n");
      ss.append("\tdurability_service.history kind: ").append(to_string(topic_qos.durability_service.history_kind)).append("\n");

      // Policy Values:
      ss.append("\tdurability_service\n");
      ss.append("\t\tservice_cleanup_delay.sec: ").append(to_string(topic_qos.durability_service.service_cleanup_delay.sec)).append("\n");
      ss.append("\t\tservice_cleanup_delay.nanosec: ").append(to_string(topic_qos.durability_service.service_cleanup_delay.nanosec)).append("\n");
      ss.append("\t\thistory_depth: ").append(to_string(topic_qos.durability_service.history_depth)).append("\n");
      ss.append("\t\tmax_samples: ").append(to_string(topic_qos.durability_service.max_samples)).append("\n");
      ss.append("\t\tmax_instances: ").append(to_string(topic_qos.durability_service.max_instances)).append("\n");
      ss.append("\t\tmax_samples_per_instance: ").append(to_string(topic_qos.durability_service.max_samples_per_instance)).append("\n");

      ss.append("\tdeadline\n");
      ss.append("\t\tperiod.sec: ").append(to_string(topic_qos.deadline.period.sec)).append("\n");
      ss.append("\t\tperiod.nanosec: ").append(to_string(topic_qos.deadline.period.nanosec)).append("\n");

      ss.append("\tlatency_budget\n");
      ss.append("\t\tduration.sec: ").append(to_string(topic_qos.latency_budget.duration.sec)).append("\n");
      ss.append("\t\tduration.nanosec: ").append(to_string(topic_qos.latency_budget.duration.nanosec)).append("\n");

      ss.append("\tliveliness\n");
      ss.append("\t\tlease_duration.sec: ").append(to_string(topic_qos.liveliness.lease_duration.sec)).append("\n");
      ss.append("\t\tlease_duration.nanosec: ").append(to_string(topic_qos.liveliness.lease_duration.nanosec)).append("\n");

      ss.append("\treliability\n");
      ss.append("\t\tmax_blocking_time.sec: ").append(to_string(topic_qos.reliability.max_blocking_time.sec)).append("\n");
      ss.append("\t\tmax_blocking_time.nanosec: ").append(to_string(topic_qos.reliability.max_blocking_time.nanosec)).append("\n");

      ss.append("\thistory.depth: ").append(to_string(topic_qos.history.depth)).append("\n");

      ss.append("\tresource_limits\n");
      ss.append("\t\tmax_samples: ").append(to_string(topic_qos.resource_limits.max_samples)).append("\n");
      ss.append("\t\tmax_instances: ").append(to_string(topic_qos.resource_limits.max_instances)).append("\n");
      ss.append("\t\tmax_samples_per_instance: ").append(to_string(topic_qos.resource_limits.max_samples_per_instance)).append("\n");

      ss.append("\ttransport_priority.value: ").append(to_string(topic_qos.transport_priority.value)).append("\n");

      ss.append("\tlifespan\n");
      ss.append("\t\tduration.sec: ").append(to_string(topic_qos.lifespan.duration.sec)).append("\n");
      ss.append("\t\tduration.nanosec: ").append(to_string(topic_qos.lifespan.duration.nanosec)).append("\n");
