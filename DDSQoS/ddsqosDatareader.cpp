 ...
 * @return
 */
int DDSQOS::SetDatareaderQos(DDS::DataReaderQos& dr_qos)
{
  if (_valid) {
    string element("");
    ...
    element = "reader_data_lifecycle.autopurge_nowriter_samples_delay.sec";
    if (!XMLReadString(element, "").empty() ) {
    ...
    element = "reader_data_lifecycle.autopurge_nowriter_samples_delay.nanosec";
    if (!XMLReadString(element, "").empty() ) {
      string autopurge_nowriter_samples_delay = _root.get<std::string>(element);
    ...
    element = "reader_data_lifecycle.autopurge_disposed_samples_delay.sec";
    if (!XMLReadString(element, "").empty() ) {
    ...
    element = "reader_data_lifecycle.autopurge_disposed_samples_delay.nanosec";
    if (!XMLReadString(element, "").empty() ) {
      string autopurge_disposed_samples_delay = _root.get<std::string>(element);
